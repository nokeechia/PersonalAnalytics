...
namespace Shared.Data
{
    public class Database
    {
        ...
        {
            return Path.Combine(exportPath, "pa_manuela.dat"); // New file name since 20.10.15
        ...
        {
            return Path.Combine(exportPath, "pa_manuela.dat"); // current version: also store settings in normal file
